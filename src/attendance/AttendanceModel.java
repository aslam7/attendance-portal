...
public class AttendanceModel {
	...
	public void readDataOf(String c) {
		...
		try {
			Object obj = parser.parse(new FileReader("./src/attendance/data/students.json"));
	...
	public void writeTodaysAttendance(ArrayList<String> present,String fname, String cls) {
		...
		try {
			FileWriter fw = new FileWriter("./src/attendance/data/attendance.json",true);
	...
	public boolean isSubmitted(String fname, String cls) {
		...
		boolean flag=false;
		try {
			BufferedReader br = new BufferedReader(new FileReader("./src/attendance/data/attendance.json"));
			String line;
	...
	public ArrayList<String> getClassesOf(String fname) {
		JSONParser parser = new JSONParser();
		try {
			Object obj = parser.parse(new FileReader("./src/attendance/data/faculty.json"));
			JSONObject jsonObj = (JSONObject)obj;
